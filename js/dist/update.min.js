...
$=jQuery=require("jquery"),require("./ext/bootstrap.min"),require("./ext/jquery.dataTables.min"),require("./ext/jquery.smoothscroll.min"),require("./ext/jquery.timeago"),require("./ext/baseTemplate");var config=require("./publicConfig.json");$(document).ready(function(){});

},{"./ext/baseTemplate":2,"./ext/bootstrap.min":3,"./ext/jquery.dataTables.min":4,"./ext/jquery.smoothscroll.min":5,"./ext/jquery.timeago":6,"./publicConfig.json":7,"jquery":1}]},{},[8]);
