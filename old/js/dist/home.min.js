...
console.info("Initialising core JavaScript..."),$("[data-toggle=tooltip]").tooltip(),console.info("Tooltips fired..."),function(o){var i=o(window).width();o(document).on("show.bs.modal",function(){i<o(window).width()&&o("body.modal-open,.navbar-fixed-top,.navbar-fixed-bottom").css("marginRight",o(window).width()-i)}),o(document).on("hidden.bs.modal",function(){o("body,.navbar-fixed-top,.navbar-fixed-bottom").css("marginRight",0)}),o(document).resize(function(){i=o(window).width()})}(jQuery),console.info("Bootstrap 3 modal hacks done...");
...
$=jQuery=require("jquery"),require("./ext/bootstrap.min"),require("./ext/jquery.dataTables.min"),require("./ext/jquery.smoothscroll.min"),require("./ext/baseTemplate");var config=require("./publicConfig.json");function startFunc(e,t){e(),setInterval(e,t)}$(document).ready(function(){var e=setInterval(function(){var t=$("iframe#twitter-widget-0");0!=t.length&&0!=t.contents().find(".TweetAuthor-screenName").length&&(t.contents().find(".TweetAuthor-screenName").css("color","#321F19"),t.contents().find(".timeline-Tweet-retweetCredit").css("color","#321F19"),clearInterval(e))},100);startFunc(function(){$.ajax({type:"GET",url:config.url.api+"public_api.php?action=onlinePlayersSum",dataType:"json",success:function(e){$(".plycount").text(e.players_online)}})},1e3*config.playerCount.refresh),console.info("Querying for playercount every "+config.playerCount.refresh+"s"),$("body").scrollspy({target:".navbar-fixed-top"}),$("#nav").smoothScroll(1e3),console.info("Smooth Scrolling for jQuery (c) mathiasbynens loaded..."),"#about"==window.location.hash&&($("#aboutModal").modal(),console.info("Looks like this is an about page firing modal ASAP...")),$(".about").click(function(){$("#aboutModal").modal("show")}),$.ajax({type:"GET",url:config.url.api+"news.php",dataType:"xml",success:function(e){var t=3;$(e).find("item").each(function(){t>0&&$("#news-feed").append('<article class="newspost content-container"><div class="content-inner"><h3 class="newspostheader"><a href="'+$(this).find("link").text()+'">'+$(this).find("title").text()+'</a></h3><div class="newspostauthor">Posted by '+$(this).find("dc\\:creator, creator").text()+'</div><div class="newspostcontent">'+$(this).find("content\\:encoded, encoded").text()+" </div>("+$(this).find("slash\\:comments, comments").text()+" Comments)</div></article>"),t--})}}),console.info("Homepage core loaded...")});

},{"./ext/baseTemplate":2,"./ext/bootstrap.min":3,"./ext/jquery.dataTables.min":4,"./ext/jquery.smoothscroll.min":5,"./publicConfig.json":7,"jquery":1}],7:[function(require,module,exports){
module.exports={"appearance":{"jumptotop":false,"link":{"forum":"https://forums.wynncraft.com/","issues":"https://forums.wynncraft.com/forums/bug-reports.108/","map":"https://map.wynncraft.com/","wiki":"https://wiki.wynncraft.com/"},"winter":false},"site":{"debug":false,"disable":{"disabled":false,"message":"We are Improving your Wynncraft Experience"},"tagline":" :: Wynncraft - The Minecraft MMORPG","version":"5.0.0-ssl"},"store":{"sale":{"active":true,"end":"2020-1-01","message":"CRAFTMAS SALE! UP TO 80% OFF","categories":{"ranks":30,"bombs":30,"pets":80,"crates":50}},"discounts":[{"active":false,"item":"vip","category":"ranks","percentage":10}],"url":"http://store.wynncraft.com/"},"url":{"api":"https://api.wynncraft.com/","site":"https://www.wynncraft.com/","cdn":"https://cdn.wynncraft.com/"},"playerCount":{"refresh":"15","ip":"play.wynncraft.com","timeout":"5000"}}
},{}]},{},[6]);
