...
<head>
    ...
    <body>
        <main>
            ...
            // Au revoir cookie
            document.cookie = "toggle=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
            </script>
                ...
                <div class="container navContainer">
                    <div class="navbar-collapse collapse">
                        <ul id="nav" class="nav navbar-nav">
                            <li class="active">
                                <a href="index.md" class="sprite-navbar-button home"></a>
                            </li>
                            <li>
                                <a href="index.html#about" class="sprite-navbar-button about"></a>
                            </li>
                            <li>
                                <a href="index.html#news" class="sprite-navbar-button news"></a>
                            </li>
                            <li>
                                <a href="https://shop.patyhank.pw" class="sprite-navbar-button store transition"></a>
                            </li>
                            <li>
                                <a id="forums" href="https://forums.wynncraft.com/" data-toggle="" class="sprite-navbar-button forums"></a>
                            </li>
                            <li>
                                <a href="help.html" class="sprite-navbar-button help transition"></a>
                            </li>
                            <li>
                                <a href="stats.html" class="sprite-navbar-button stats transition"></a>
                            </li>
                            <li>
                                <a id="map" href="https://map.wynncraft.com/" data-toggle="" class="sprite-navbar-button map"></a>
                            </li>
                            </ul>
                                <a id="ipImage" data-clipboard-text="play.wynncraft.com" title="點擊複製到剪貼版" style="margin-top:0.75%"></a>
                            <script>
                            var clipboard = new Clipboard('#ipImage');
clipboard.on('success', function(e) {
alert("Successfully Copied!");
e.clearSelection();
});
clipboard.on('error', function(e) {});</script></div></div></nav><noscript><div role="alert" class="alert alert-warning no-js">For full functionality of this site it is necessary to enable JavaScript.
Here are the <a href="http://www.enable-javascript.com/" target="_blank">instructions how to enable JavaScript in your web browser</a>.</div></noscript><div id="content"><div id="transition"><script type="text/javascript" src="js/dist/home.min.js"></script><header id="introouter" class="section sectionwrapper"><div id="home"></div><div id="intro"><img src="https://cdn.wynncraft.com/img/intro.png" alt="intro" width="3840" height="2160"></div><div id="logoholder"><img src="https://cdn.wynncraft.com/img/logo.png" alt="Wynncraft Logo" width="643" height="224" class="wynn-logo center-block"><div id="serverstatus"><h1>play.wynncraft.com</h1><h4><span class="plycount">0</span> 名玩家正在遊玩!</h4><h4 id="slogan"><strong>Wynncraft, Minecraft大型多人連線角色扮演 (MMORPG)</strong></h4></div></div></header><section id="news" class="section"><h1 class="hidden">新聞</h1><div class="container"><section id="newscontent" class="col-xs-8"><h2 class="text-white">最新消息</h2><div id="news-feed"></div></section><section id="sidebar" class="col-xs-4 content-container"><div class="content-inner"><a href="https://discord.gg/QfXb2P3" style="position:relative" target="_blank"><img src="https://cdn.wynncraft.com/img/DiscordOfficialBrandingButton.png" style="transform: translateX(50%); background-color:transparent; cursor: pointer; max-width:50%; max-height:50%;"></a><h4>Latest Tweets</h4><a href="https://twitter.com/Wynncraft" data-chrome="noheader nofooter transparent noscrollbar" data-tweet-limit="5" link-color="#43ac6a" data-widget-id="390906412475228160" class="twitter-timeline">Tweets by @Wynncraft</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");
$('iframe#twitter-widget-0').contents().find('.TweetAuthor-screenName').css('color', '#FF0000')
</script></div></section></div></section></div><footer class="footer-wrapper"><div class="footer-img"></div><div id="footer"><div class="footer-inner center-block"><div class="footer-left text-left pull-left"><a href="mailto:support@wynncraft.com">商業諮詢</a><a href="mailto:support@wynncraft.com">帳戶與帳單支援</a><a href="https://forums.wynncraft.com/forums/bug-reports.108/">漏洞回報
</a><a href="https://wiki.wynncraft.com/">維基</a></div><div class="text-right"><p>Wynncraft 2013 - 2018 版權所有。 與Mojang AB或Microsoft Coporation無關。</p></div></div></div></footer></div></main><div id="aboutModal" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade modal-help"><div class="modal-dialog"><div class="modal-content"><div class="modal-inner"><div class="modal-header"><button type="button" data-dismiss="modal" aria-hidden="true" class="close">×</button><h4 class="modal-title">關於</h4></div><div class="modal-body"><section id="introduction" class="text-center"><img src="https://cdn.wynncraft.com/img/wynn.png" width="200" height="221" class="center-block"/><h2>什麼是Wynncraft?</h2><p>Wynncraft是在Minecraft中最大的 MMORPG (大型多人連線角色扮演)。
只要你擁有網際網路以及一個Minecraft帳號，你就可以免費遊玩。</p><p>開始你在Wynn大陸裡從零開始的旅程以及探索Minecraft中其中一個最大和
最具細節的冒險地圖。 與你的朋友一起遊玩來獲取經驗並
